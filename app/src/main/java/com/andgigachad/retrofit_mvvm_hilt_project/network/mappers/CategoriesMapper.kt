...
import com.andgigachad.retrofit_mvvm_hilt_project.domain.util.CategoryDomainMapper
import com.andgigachad.retrofit_mvvm_hilt_project.network.model.CategoriesNetwork

class CategoriesMapper : CategoryDomainMapper<CategoriesNetwork, CategoriesDomain>{
